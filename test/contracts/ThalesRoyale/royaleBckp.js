...
// const { artifacts, contract, web3, upgrades } = require('hardhat');
...
// 				'Can not start, no players in a season'
// 			);
// 		});
...
// 			// 5th sold the position to 1st
// 			assert.equal(await royale.isPlayerAlive(first), true);
// 			assert.equal(await royale.isPlayerAlive(fifth), false);
...
// 			hasParticipatedInCurrentOrLastRoyale = await royale.hasParticipatedInCurrentOrLastRoyale(
// 				fourth
// 			);
...
// 		//#3
// 		// 5th sold the position to 1st, etc
// 		assert.equal(await royale.isPlayerAlive(first), true);
// 		assert.equal(await royale.isPlayerAlive(second), true);
// 		assert.equal(await royale.isPlayerAlive(fifth), false);
// 		assert.equal(await royale.isPlayerAlive(sixth), false);
...
// 		console.log("first tokens", await royale.getPlayerTokensPerSeason(first, 1));
// 		console.log("second tokens", await royale.getPlayerTokensPerSeason(second, 1));
...
// 		let isPlayerThirdAlive = await royale.isPlayerAlive(third);
// 		let isPlayerFourthAlive = await royale.isPlayerAlive(fourth);
// 		let isPlayerFifthAlive = await royale.isPlayerAlive(fifth);
// 		let isPlayerSixthAlive = await royale.isPlayerAlive(sixth);
// 		let isPlayerSeventhAlive = await royale.isPlayerAlive(seventh);

// 		assert.equal(true, isPlayerFirstAlive);
// 		assert.equal(true, isPlayerSecondAlive);
// 		assert.equal(false, isPlayerThirdAlive);
// 		assert.equal(false, isPlayerFourthAlive);
// 		assert.equal(false, isPlayerFifthAlive);
// 		assert.equal(false, isPlayerSixthAlive);
// 		assert.equal(false, isPlayerSeventhAlive);

// 		let rewardPerPlayer = await royale.rewardPerWinnerPerSeason(season_1);
// 		// 17.500 -> two winners 8.750
// 		assert.bnEqual(rewardPerPlayer, toUnit(8750));
...
// 		console.log("first tokens season 2", await royale.getPlayerTokensPerSeason(first, 2));
// 		console.log("fifth tokens season 2", await royale.getPlayerTokensPerSeason(fifth, 2));
...
// 		let isPlayerFifthAlive_s2 = await royale.isPlayerAlive(fifth);
// 		let isPlayerSixthAlive_s2 = await royale.isPlayerAlive(sixth);
// 		let isPlayerSeventhAlive_s2 = await royale.isPlayerAlive(seventh);
...
// 		assert.equal(false, isPlayerFifthAlive_s2);
// 		assert.equal(false, isPlayerSixthAlive_s2);
// 		assert.equal(false, isPlayerSeventhAlive_s2);

// 		let rewardPerPlayer_s2 = await royale.rewardPerWinnerPerSeason(season_2);
// 		assert.bnEqual(rewardPerPlayer_s2, toUnit(27500));
