...
//
// 			await thalesAMM.setSpentOnMarket(newMarket.address, toUnit(2074), { from: owner });
//
// 			availableToBuyFromAMM = await thalesAMM.availableToBuyFromAMM(newMarket.address, Position.UP);
// 			console.log('availableToBuyFromAMM UP post buy decimal is:' + availableToBuyFromAMM / 1e18);
//
...
//
//
// 			let availableToBuyFromAMMShort = await thalesAMM.availableToBuyFromAMM(
// 				newMarket.address,
// 				Position.DOWN
// 			);
// 			console.log(
// 				'availableToBuyFromAMM DOWN post buy decimal is:' + availableToBuyFromAMMShort / 1e18
// 			);
// 			let buyPriceImpactPostBuyShort = await thalesAMM.buyPriceImpact(
// 				newMarket.address,
// 				Position.DOWN,
// 				toUnit(availableToBuyFromAMMShort / 1e18)
// 			);
// 			console.log(
// 				'buyPriceImpactPostBuyShort post buy max  decimal is:' + buyPriceImpactPostBuyShort / 1e18
// 			);
// 		});
// 	});
// });
