...
async function main() {
    ...
    setTargetAddress('SportPositionalMarketMastercopy', network, SportPositionalMarketDeployed.address);
	
    // await delay(5000);
    // await SportMarketManagerDeployed.setPositionalMarketFactory(SportMarketFactoryDeployed.address, {from: owner.address});
    await delay(5000);
    await SportMarketFactoryDeployed.setPositionalMarketMastercopy(SportPositionalMarketDeployed.address, {from: owner.address});
    ...
    try {
		await hre.run('verify:verify', {
            ...
            contract: "contracts/SportMarkets/SportPositions/SportPositionalMarketMastercopy.sol:SportPositionalMarketMastercopy"
		});
	} catch (e) {
		console.log(e);
	}
