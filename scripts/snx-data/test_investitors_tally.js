...
for (let [key, value] of Object.entries(investitors)) {
  investitorsTotalAmountWithoutStaking = investitorsTotalAmountWithoutStaking.add(w3utils.toWei(value + ''));
...
console.log('investitors total amount without staking', investitorsTotalAmountWithoutStaking.toString());
