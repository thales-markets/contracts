...
contract('Exotic Positional market', async accounts => {
	...
	// 			beforeEach(async () => {
	// 				answer = await deployedMarket.takeOpenBidPositions([outcomePosition, outcomePosition2],[positionAmount1, positionAmount2], { from: userOne });
	// 			});
	// 			it('1 ticket holder', async function() {
	// 				answer = await deployedMarket.totalUsersTakenPositions();
	// 				assert.equal(answer, "1");
	...
	// 			beforeEach(async () => {
	// 				answer = await deployedMarket.takeOpenBidPositions([outcomePosition, outcomePosition2],[positionAmount1, positionAmount2], { from: userOne });
	// 				answer = await deployedMarket.takeOpenBidPositions([outcomePosition2, outcomePosition3],[positionAmount2, positionAmount3], { from: userTwo });
	// 			});
	// 			it('1 ticket holder', async function() {
	// 				answer = await deployedMarket.totalUsersTakenPositions();
	...
	// 				assert.equal(answer[0].toString(), positionAmount1);
	// 				assert.equal(answer[1].toString(), positionAmount2);
	// 				answer = await deployedMarket.getAllUserPositions(userTwo);
