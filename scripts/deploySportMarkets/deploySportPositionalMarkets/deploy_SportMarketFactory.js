...
async function main() {
	...
	setTargetAddress('SportPositionalMarketFactoryImplementation', network, SportMarketFactoryImplementation);
	...
	await delay(5000);
    await SportMarketFactoryDeployed.setPositionalMarketManager(SportMarketManagerDeployed.address, {from: owner.address});
