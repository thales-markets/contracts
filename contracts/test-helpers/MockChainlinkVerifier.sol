...
import {IVerifierProxy} from "@chainlink/contracts-0.8.0/src/v0.8/llo-feeds/interfaces/IVerifierProxy.sol";
import {IVerifier} from "@chainlink/contracts-0.8.0/src/v0.8/llo-feeds/interfaces/IVerifier.sol";
import {TypeAndVersionInterface} from "@chainlink/contracts-0.8.0/src/v0.8/interfaces/TypeAndVersionInterface.sol";
import {AccessControllerInterface} from "@chainlink/contracts-0.8.0/src/v0.8/shared/interfaces/AccessControllerInterface.sol";
import {IERC165} from "@chainlink/contracts-0.8.0/src/v0.8/vendor/openzeppelin-solidity/v4.8.0/contracts/interfaces/IERC165.sol";
import {IVerifierFeeManager} from "@chainlink/contracts-0.8.0/src/v0.8/llo-feeds/interfaces/IVerifierFeeManager.sol";
import {Common} from "@chainlink/contracts-0.8.0/src/v0.8/libraries/Common.sol";

import "../SpeedMarkets/ChainlinkStructs.sol";

contract MockChainlinkVerifier is IVerifierProxy, ConfirmedOwner, TypeAndVersionInterface {
    ...
    function createUnverifiedReport(
        bytes32 feedId,
        ...
        ChainlinkStructs.ReportV3 memory reportV3;

        reportV3.feedId = feedId;

        reportV3.validFromTimestamp = validFromTimestamp;
        reportV3.observationsTimestamp = validFromTimestamp;

        reportV3.nativeFee = nativefee;
        reportV3.linkFee = linkFee;

        reportV3.expiresAt = validFromTimestamp;

        reportV3.price = price;
        reportV3.bid = price;
        reportV3.ask = price;
