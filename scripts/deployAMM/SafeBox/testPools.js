...
async function main() {
    ...
    // thales
	const IUniswapV3PoolThales = await ethers.getContractAt('IUniswapV3Pool', '0xff7fbdf7832ae524deda39ca402e03d92adff7a5');
	// susd
    const IUniswapV3PoolsUSD = await ethers.getContractAt('IUniswapV3Pool', '0x2e80d5a7b3c613d854ee43243ff09808108561eb');

	const IUniswapFactory = await ethers.getContractAt('IUniswapV3Factory', '0x1f98431c8ad98523631ae4a59f267346ea31f984');
